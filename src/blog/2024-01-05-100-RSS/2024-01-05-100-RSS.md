...
socialMediaPreviewImage: https://blog.davidmoll.net/assets/images/{{folderName}}/cover.png
...
{% raw %}---json
{
  ...
  "metadata": {
    ...
    "author": {
      "name": "David Moll",
      "url": "david.leander.moll@gmail.com"
    }
  }
}
---
...
<rss version="2.0" xmlns:dc="http://purl.org/dc/elements/1.1/" xml:base="{{ metadata.url }}" xmlns:atom="http://www.w3.org/2005/Atom">
  <channel>
    ...
    <managingEditor>david.leander.moll@gmail.com (David Moll)</managingEditor>
    <webMaster>david.leander.moll@gmail.com (David Moll)</webMaster>
