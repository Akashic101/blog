...
To update your blog with new content you can update the repo by navigating into it and entering `git pull` followed by `npx @11ty/eleventy`. That command will build the static files with the new command.
